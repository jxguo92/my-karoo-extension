...
热门Karoo Extension列表: [awesome-karoo](https://github.com/timklge/awesome-karoo)。
...
5. 计划模式应自动将计划markdown保存至 docs/plans 内
6. prototype/demo保存至 demo/ 内
